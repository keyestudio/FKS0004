...
<span style="color: rgb(255, 76, 65);">**Nota che la distanza tra la 4ª e la 5ª banda (la 3ª e la 4ª) è relativamente ampia in un resistore a 5 bande (4 bande).**</span>
...
Dopo aver scaricato il codice sulla scheda, la matrice LED 5x5 mostra l'icona ![Img](./media/A512.png). Premi il pulsante A, e la matrice LED 5x5 mostra l'icona ![Img](./media/A518.png), il LED si accende. Premi il pulsante B, la matrice LED 5x5 mostra l'icona ![Img](./media/A527.png), il LED si spegne. Sembra una mini lampada?
